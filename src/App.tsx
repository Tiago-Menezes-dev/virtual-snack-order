...
const App = () => {
  ...
  return (
    ...
    <TooltipProvider>
      ...
      <BrowserRouter>
        <Routes>
          <Route path="/" element={<CreateUser user={user} />} />
          <Route path="/painel" element={<ProtectedRoute user={user}><Painel /></ProtectedRoute>} />
          <Route path="/menu/:businessName" element={<Index />} />
